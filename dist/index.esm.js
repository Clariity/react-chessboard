import React, { createContext, memo, useEffect, isValidElement, cloneElement, useLayoutEffect, useMemo, useContext, useState, useCallback, useRef } from 'react';
import 'react-dom';
...
function ChessboardProvider({
  ...
  const [positionDifferences, setPositionDifferences] = useState({}); // chess pieces
  ...
  const [previousTimeout, setPreviousTimeout] = useState(); // screen size
...
function Piece({
  ...
  useEffect(() => {
    ...
    const newSquare = Object.entries(positionDifferences.added).find(([_, v]) => v === removedPiece); // we can perform animation if our square was in removed, AND the matching piece is in added
...
function Board() {
  ...
  return screenSize && boardWidth ? /*#__PURE__*/jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.exports.jsx(HookPreview, {}), /*#__PURE__*/jsxRuntime.exports.jsx(Squares, {
      children: ({
        square,
        squareColor,
        col,
...
function Chessboard(props) {
  return /*#__PURE__*/jsxRuntime.exports.jsx(ErrorBoundary, {
    children: /*#__PURE__*/jsxRuntime.exports.jsx(DndProvider, {
      ...
      children: /*#__PURE__*/jsxRuntime.exports.jsx(ChessboardProvider, { ...props,
        children: /*#__PURE__*/jsxRuntime.exports.jsx("div", {
