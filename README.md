...
| onCheckForPromotion           | function: (sourceSquare, targetSquare) => false                   | returns [true, false]                              | User function that is run when piece is dropped. Must return whether the move results in a promotion or not.                                                                                                                                                                                                                                                                 |
...
| onPromotionDialogOpen         | function: (sourceSquare, targetSquare) => true                    | returns [true, false]                              | User function that is run when pawn is dropped on a promotion square. Must return whether the move was valid or not.                                                                                                                                                                                                                                                                 |
