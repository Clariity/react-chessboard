...
| boardDimensions         | object: { rows: 8, columns: 8 }                                                                                                                                                                                                                                            | integer: 0 < { rows, columns } <= 12                                 | Custom board dimensions to for use in some chess variants. Supports up to a 12x12 board.                                                                                                                                                                                                                                                                                                                                                  |
