...
<div
  style={{ textAlign: "center", marginTop: "3rem", color: "#666", fontSize: "0.8rem" }}
>
  🎉 You made it to the bottom! Here's a fun fact: The number of possible unique chess
  games is greater than the number of atoms in the observable universe. Keep exploring and
  happy coding! 🎮
</div>
