...
import * as ArrowSettingsStories from './stories/options/ArrowSettings.stories';
...
- [Component options](#component-options)
  ...
  - [`options.allowDrawingArrows`](#optionsallowdrawingarrows)
  - [`options.alphaNotationStyle`](#optionsalphanotationstyle)
  - [`options.animationDurationInMs`](#optionsanimationdurationinms)
  - [`options.arrows`](#optionsarrows)
  - [`options.arrowSettings`](#optionsarrowsettings)
  ...
  - [`options.clearArrowsOnClick`](#optionscleararrowsonclick)
  - [`options.darkSquareNotationStyle`](#optionsdarksquarenotationstyle)
  - [`options.darkSquareStyle`](#optionsdarksquarestyle)
  - [`options.dragActivationDistance`](#optionsdragactivationdistance)
  - [`options.draggingPieceStyle`](#optionsdraggingpiecestyle)
  - [`options.draggingPieceGhostStyle`](#optionsdraggingpieceghoststyle)
...
By default, these arrows will not be automatically cleared when a square is clicked or a piece is dragged. Instead, you will need to clear them manually using the [`onSquareClick`](#optionsonsquareclick) or [`onPieceDragStart`](#optionsonpiecedragstart) prop and pass in a new value for this prop.

**Default value:** `[]`

**TypeScript type:** `{ startSquare: string, endSquare: string, color: string }[]`

**Standard use case:** Adding arrows to the board to indicate possible moves or attacks.

<Canvas of={ArrowsStories.Arrows} />

### `options.arrowSettings`
...
**TypeScript type:** `{ color: string, secondaryColor: string, tertiaryColor: string, arrowLengthReducerDenominator: number, sameTargetArrowLengthReducerDenominator: number, arrowWidthDenominator: number, activeArrowWidthMultiplier: number, opacity: number, activeOpacity: number }`
...
<Canvas of={ArrowSettingsStories.ArrowSettings} />
