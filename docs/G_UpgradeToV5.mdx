...
- v4.7.4 = 97.4kB minified / 25.5kB minified + gzipped
- v5.0.0 = 71.1kB minified / 20.7kB minified + gzipped
- v5 is 27% smaller minified and 19% smaller gzipped
- less dependencies
...
| `onPieceDragBegin`              | Renamed to `onPieceDrag`                                                                                       | Same functionality, new name                                       |
...
| `onPieceDrag`        | `(piece, sourceSquare)`               | `({ isSparePiece: boolean, piece: { pieceType: string }, square: string \| null })`                                               | Added `isSparePiece` flag and structured piece data |
